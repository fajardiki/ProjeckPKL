	...
	*/
	class M_admin extends CI_Model {
		...
		public function getefos($date) {
			$hsl = $this->db->query("SELECT * FROM m_efos a LEFT JOIN m_selesman b ON a.Emp_Code = b.Emp_Code LEFT JOIN m_ruote c ON a.District_Code = c.District_Code WHERE Date_Update='$date' ORDER BY Journey_Date");
			return $hsl->result_array();
		}
		...
		public function selectallplane() {
 		...
 		// Summary
 		public function selectsummaryconcesjogja() {
