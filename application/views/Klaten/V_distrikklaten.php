...
<div class="jumbotron jumbotron-fluid" style="margin: 0; padding: 0; text-align: center; margin-top: 70px;">
    <h1 class="lead" style="padding: 10px;">District Klaten</h1>
</div>
		...
		<table class="table table-bordered" style="text-align: center;">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td><a href="<?php echo base_url().'C_klaten/hapusdistrict/'.$ud['District_Code'] ?>" class="card-link fas fa-trash" style="font-size:15px;" onclick="return confirm('Anda yakin ingin menghapus district ini ?')"></a></td>
		    </tr>
		    <?php $no++; ?>
			<?php } ?>
		   </tbody>
	...
	<section class="mt-1" style="margin-bottom: 70px;">
		<a class="btn btn-dark" style="width: 100%" href="<?php echo base_url().'C_klaten/savedistrict' ?>">Tambah</a>
	</section>
