      ...
      <div class="col-sm-4" id="form_login">
        ...
        <form action="<?php echo base_url().'C_login_admin/login'; ?>" method="post">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputAddress" placeholder="Input Username" name="username" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="inputAddress">Password</label>
            <input type="password" class="form-control" id="inputAddress" placeholder="Input Password" name="password" autocomplete="off">
          </div>
