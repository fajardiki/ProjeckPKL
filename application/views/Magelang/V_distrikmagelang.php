	...
	<table class="table table-bordered" style="text-align: center;">
	  ...
	  <tbody>
	    ...
	    <tr>
		  ...
		  <td><a href="<?php echo base_url().'C_magelang/hapusdistrict/'.$ud['District_Code'] ?>" class="card-link fas fa-trash" style="font-size:15px;" onclick="return confirm('Anda yakin ingin menghapus district ini ?')"></a></td>
	    </tr>
	    <?php $no++; ?>
		<?php } ?>
	   </tbody>
