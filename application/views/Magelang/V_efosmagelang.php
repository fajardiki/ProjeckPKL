...
<div class="jumbotron jumbotron-fluid mb-1" style="margin: 0; padding: 0; text-align: center; height: 50px;">
    <h1 class="lead pt-3">EFOS Magelang</h1>
</div>

<form class="input-group mb-2" action="<?php echo base_url().'C_magelang/efosallselect' ?>" method="post">
	    ...
	    <section id="head" style="margin-bottom: 25px" hidden="true">
	      ...
	      <section id="namasales" hidden="true">
	        <section align="center">
	          <h3>Summary Magelang <?php echo $efosall[0]['month']; ?> <?php echo $efosall[0]['year']; ?></h3>
	        </section>
