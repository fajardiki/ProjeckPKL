...
<div class="container-fluid">
  <div class="row">
  	...
  	<div class="col-sm-8">
  		<h1 class="mt-2" align="center" style="font-size: 4vw;">Update District Magelang</h1>
  ...
  <div class="row">
    <div class="col-sm-2"></div>
    <div class="col-sm-8">
      <form action="<?php echo base_url().'C_magelang/updatedistrict' ?>" method="post">
        ...
        <div class="form-group row">
          <div class="col-sm-12">
            <a type="submit" class="btn btn-block btn-danger" href="<?php echo base_url().'C_magelang/updatedistrict' ?>">Kembali</a>
          </div>
        </div>
    </div>
  </div>
