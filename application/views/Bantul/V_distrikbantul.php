			...
			<table class="table table-sm" style="text-align: center;">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td><a href="<?php echo base_url().'C_bantul/updatedistrict/'.$ud['District_Code'] ?> ?>" class="card-link fa fa-edit" style="font-size:15px;"></a></td>
			      <td><a href="<?php echo base_url().'C_bantul/hapusdistrict/'.$ud['District_Code'] ?>" class="card-link fa fa-trash" style="font-size:15px;"></a></td>
			    </tr>
			    <?php $no++; ?>
				<?php } ?>
				<tr>
					<td colspan="8"><a class="btn btn-dark" style="width: 100%" href="<?php echo base_url().'C_bantul/savedistrict' ?>">Tambah</a></td>
				</tr>
			   </tbody>
			</table>
		</div>
