    ...
    <div class="col-sm-8">
      <form action="<?php echo base_url().'C_dasbord/tambahuser' ?>" method="post">
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="iduser" value="" autocomplete="off">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
    		  <div class="col-sm-12">
    		   <input type="submit" class="btn btn-block btn-danger" value="Simpan" name="save" onclick="return confirm('Anda yakin ingin menyimpan data user ini ?')">
    		  </div>
    		</div>
      </form>
        <div class="form-group row">
