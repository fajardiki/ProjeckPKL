...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-8">
      <h1 class="mt-2" align="center" style="font-size: 3vw;">Tambah Salesman Jogja</h1>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      ?>
      <form action="<?php echo base_url().'C_jogja/savesales' ?>" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" readonly class="form-control" name="status" value="sales" autocomplete="off">
          </div>
        </div>
        <div class="form-group row">
