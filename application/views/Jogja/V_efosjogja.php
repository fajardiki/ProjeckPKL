...
<div class="jumbotron jumbotron-fluid mb-1" style="margin: 0; padding: 0; text-align: center; height: 50px;">
    <h1 class="lead pt-3">EFOS Jogja</h1>
</div>
<form class="input-group mb-2" action="<?php echo base_url().'C_jogja/efosallselect' ?>" method="post">
...
<section style="overflow-x: scroll; margin-bottom: 10%;" >
	<section id="printArea">
		<section id="head" hidden="true">
			<h2 class="h2" align="center">Efos Jogja Bulan <?php echo $efosall[0]['month']; ?></h2>
